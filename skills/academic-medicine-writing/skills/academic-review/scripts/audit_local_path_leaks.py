#!/usr/bin/env python3
"""Audit medical paper artifacts for leaked local workspace paths."""
...
# Blocks common Unix and Windows user/workspace path prefixes.
...
def main() -> int:
    ...
    if args.json:
        ...
        if leaks:
            print("FAIL medical local path leak audit")
            for leak in leaks:
                print(
            ...
            print("PASS medical local path leak audit")
